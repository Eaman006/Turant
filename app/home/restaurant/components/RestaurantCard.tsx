...
import {
  getDisplayRestaurantTags,
  getNormalizedRestaurantTags,
} from "@/app/lib/restaurantTags";
import { incrementRestaurantVectorFromTags } from "@/app/lib/userVector";
...
export default function RestaurantCard({ place }: { place: RestaurantPlace }) {
  ...
  const chipLabels = getDisplayRestaurantTags(place);

  function handleCardPress() {
    incrementRestaurantVectorFromTags(getNormalizedRestaurantTags(place));
  }
