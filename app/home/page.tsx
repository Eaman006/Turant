    ...
    <div className=''>
      <div className=''>
        ...
        <div className='ml-28 mr-10 pt-10'>
          ...
          <div className='bg-gradient-to-r from-[#E67E22]/50 to-[#F39C12]/50 mt-10 flex justify-center items-center p-4 rounded-2xl'>
            <div className='font-bold text-5xl text-white m-6 p-6'>
