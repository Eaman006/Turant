...
import RateGroceryModal from "./RateGroceryModal";
import {
  getDisplayGroceryTags,
  getNormalizedGroceryTags,
} from "@/app/lib/groceryTags";
import { incrementGroceryVectorFromTags } from "@/app/lib/userVector";
...
export default function GroceryCard({ place }: { place: GroceryPlace }) {
  ...
  const chipLabels = getDisplayGroceryTags(place);

  function handleCardPress() {
    incrementGroceryVectorFromTags(getNormalizedGroceryTags(place));
  }
        ...
        <div className="flex justify-between items-start w-full">
          <div>
            ...
            <div className="flex gap-2 items-center mt-1">
              ...
              >
                [{hasRated ? "Edit ratings" : "Rate this store"}]
              </div>
            </div>
